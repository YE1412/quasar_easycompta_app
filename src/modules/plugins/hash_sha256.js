...
var hashModule = (() => {
  ...
  return function (hashModule) {
    hashModule = hashModule || {};

    var Module = typeof hashModule != "undefined" ? hashModule : {};
    ...
    if (Module["locateFile"]) {
      ...
      wasmBinaryFile = new URL("hash_sha256.wasm", import.meta.url).toString();
    }
    ...
    var _hash = (Module["_hash"] = createExportWrapper("hash"));

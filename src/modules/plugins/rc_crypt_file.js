...
var cryptFileModule = (() => {
  ...
  return function (cryptFileModule) {
    cryptFileModule = cryptFileModule || {};

    var Module = typeof cryptFileModule != "undefined" ? cryptFileModule : {};
    ...
    var _rc_crypt_file = (Module["_rc_crypt_file"] =
      createExportWrapper("rc_crypt_file"));
    ...
    return cryptFileModule.ready;
  };
})();
export default cryptFileModule;

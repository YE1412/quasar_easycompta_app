...
var generateModule = (() => {
  ...
  return function (generateModule) {
    generateModule = generateModule || {};

    var Module = typeof generateModule != "undefined" ? generateModule : {};
    ...
    if (Module["locateFile"]) {
      wasmBinaryFile = "generate.wasm";
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      wasmBinaryFile = new URL("generate.wasm", import.meta.url).toString();
    }
      ...
      switch (type) {
        ...
        case "i64":
          (tempI64 = [
            ...
            SAFE_HEAP_STORE((ptr >> 2) * 4, tempI64[0], 4),
            SAFE_HEAP_STORE(((ptr + 4) >> 2) * 4, tempI64[1], 4);
          break;

...
var decryptModule = (() => {
  ...
  return function (decryptModule) {
    decryptModule = decryptModule || {};

    var Module = typeof decryptModule != "undefined" ? decryptModule : {};
    ...
    if (Module["locateFile"]) {
      ...
      wasmBinaryFile = new URL("rc_decrypt.wasm", import.meta.url).toString();
    }
    ...
    var _rc_decrypt = (Module["_rc_decrypt"] =
      createExportWrapper("rc_decrypt"));

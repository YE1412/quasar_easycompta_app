...
var decryptFileModule = (() => {
  ...
  return function (decryptFileModule) {
    decryptFileModule = decryptFileModule || {};

    var Module =
      typeof decryptFileModule != "undefined" ? decryptFileModule : {};
    ...
    var _rc_decrypt_file = (Module["_rc_decrypt_file"] =
      createExportWrapper("rc_decrypt_file"));
    ...
    return decryptFileModule.ready;
  };
})();
export default decryptFileModule;

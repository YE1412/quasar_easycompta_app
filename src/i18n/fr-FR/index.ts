...
export default {
  ...
  startTitle: 'Départ',
  startLinkName: 'Start',
  startLinkTarget: '/depart',
  registerTitle: 'S\'enregistrer',
  registerLinkName: 'Register',
  registerLinkTarget: '/inscription',
  homeTitle: 'Accueil',
  homeLinkName: 'Home',
  homeLinkTarget: '/accueil',
  homeBisLinkName: 'HomeBis',
  homeBisLinkTarget: '',
  homeTerLinkName: 'HomeTer',
  homeTerLinkTarget: '/accueil',
  profileTitle: 'Profil',
  profileLinkName: 'Profile',
  profileLinkTarget: '/profil',
  aboutTitle: 'À Propos',
  aboutLinkName: 'About',
  aboutLinkTarget: '/a-propos',
  serviceTitle: 'Service',
  serviceLinkName: 'Service',
  serviceLinkTarget: '/service/:type?',
  actorTitle: 'Acteur',
  actorLinkName: 'Actor',
  actorLinkTarget: '/acteur/:type?',
  orderTitle: 'Commande',
  orderLinkName: 'Order',
  orderLinkTarget: '/commande/:type?',
  paymentTitle: 'Paiement',
  paymentLinkName: 'Payment',
  paymentLinkTarget: '/paiement/:type?',
  invoiceTitle: 'Facture',
  invoiceLinkName: 'Invoice',
  invoiceLinkTarget: '/facture/:type?',

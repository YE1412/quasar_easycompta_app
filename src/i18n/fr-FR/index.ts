...
export default {
  ...
  actorsComponent: {
    ...
    hints: {
      ...
      streetName: 'Le nom de rue doit contenir au moins 2 caractères et moins de 15 caractères alphabétiques !',
      cp: 'Le code postal doit contenir 5 caractères numériques (ex: 01000) !',
      city: 'La ville doit contenir au moins 2 caractères et moins de 15 caractères alphabétiques !',
